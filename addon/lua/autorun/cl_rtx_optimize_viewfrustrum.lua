...
local function UpdateCacheSettings()
    ...
    Cache.gridSize = cv_static_prop_cell_size:GetFloat()
...
cvars.AddChangeCallback("fr_static_prop_cell_size", UpdateCacheSettings)
...
cvars.AddChangeCallback("fr_updater_distance", function(convar, old, new)
    Cache.lastRTXUpdate = 0 -- Force RTX updaters refresh
    Cache.rtxQueue = {} -- Clear RTX queue to force rebuild
end)
